...
function Layout() {
  ...
  return (
    <div className="h-screen bg-gray-950 text-gray-100 flex overflow-hidden">
      ...
      <aside
        className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 h-full
      ...
      >
        <div className="h-full flex flex-col p-6 overflow-y-auto custom-scrollbar">
          ...
          <button
            onClick={onLogout}
            className="mt-8 flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-red-400 transition-colors rounded-2xl hover:bg-red-500/5 shrink-0"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        {/* Header */}
        <header className="h-16 bg-gray-900 border-b border-gray-800 flex items-center justify-between px-6 lg:px-10 shrink-0">
          <button
