          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {formData.items.map((item, index) => (
                <div key={index} className="grid grid-cols-12 gap-4 items-end bg-gray-900/30 p-4 rounded-2xl border border-gray-800/50">
          ...
          <div className="flex flex-col items-end space-y-4 pt-4 border-t border-gray-800">
            <div className="w-full max-w-xs space-y-4">
              <div className="flex justify-between items-center text-gray-400">
                ...
                <span className="text-lg font-bold text-white">${calculateSubtotal().toLocaleString()}</span>
              </div>
              <div className="flex items-center gap-4">
                <label className="text-xs font-bold text-gray-500 uppercase shrink-0">Tax Amount</label>
                <input
                  type="number"
              ...
              <div className="flex justify-between items-center pt-4 border-t border-gray-800">
                <span className="text-lg uppercase font-black text-blue-400 tracking-tighter">Total Amount</span>
                <span className="text-3xl font-black text-white">${(calculateSubtotal() + (parseFloat(formData.tax) || 0)).toLocaleString()}</span>
              </div>
            </div>
          </div>
        </form>
