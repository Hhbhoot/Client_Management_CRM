          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-950/50 border-b border-gray-800">
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Client Details</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Company</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Phone</th>
