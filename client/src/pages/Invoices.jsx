    ...
    <div className="space-y-10 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-gray-400 mt-2 text-lg">Manage your client payments and professional documentation.</p>
        </div>
        <button
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-900 border-b border-gray-800">
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Invoice #</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Client</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Date</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Status</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Total</th>
                <th className="px-8 py-6 text-sm font-bold text-gray-500 uppercase tracking-widest">Actions</th>
              </tr>
            </thead>
              ...
              {invoices.length === 0 ? (
                ...
                invoices.map((invoice) => (
                  <tr key={invoice._id} className="hover:bg-gray-800/20 transition-colors group">
                    ...
                    <td className="px-8 py-6 text-gray-400">{new Date(invoice.createdAt).toLocaleDateString()}</td>
                    <td className="px-8 py-6">
                    ...
                    <td className="px-8 py-6 text-xl font-black text-white">${invoice.totalAmount.toLocaleString()}</td>
                    <td className="px-8 py-6">
